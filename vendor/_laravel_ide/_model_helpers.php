...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<candidate>|candidate whereFirstname($value)
     * @method static \Illuminate\Database\Eloquent\Builder<candidate>|candidate whereSecondname($value)
     * @method static \Illuminate\Database\Eloquent\Builder<candidate>|candidate whereGender($value)
     * @method static \Illuminate\Database\Eloquent\Builder<candidate>|candidate whereDof($value)
     * @method static \Illuminate\Database\Eloquent\Builder<candidate>|candidate whereExamdate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<candidate>|candidate wherePhonenumber($value)
     ...
     * @property mixed $obtainedMarks_20
     * @property string $licenseExamCategory
     * @property mixed $candidateNationalId
     * @property int $id
     * @property-read \App\Models\candidate $candidate
     * @method static \Illuminate\Database\Eloquent\Builder<grade>|grade whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<grade>|grade whereCandidatenationalid($value)
     * @method static \Illuminate\Database\Eloquent\Builder<grade>|grade whereLicenseexamcategory($value)
     * @method static \Illuminate\Database\Eloquent\Builder<grade>|grade whereObtainedmarks20($value)
     * @method static \Illuminate\Database\Eloquent\Builder<grade>|grade whereDecision($value)
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<register>|register whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<register>|register whereAdminname($value)
     * @method static \Illuminate\Database\Eloquent\Builder<register>|register whereAdminpassword($value)
     * @method static \Illuminate\Database\Eloquent\Builder<register>|register whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<register>|register whereUpdatedAt($value)
